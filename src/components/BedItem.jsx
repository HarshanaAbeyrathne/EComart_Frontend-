...
function BedItem({ title, description, price, image, onAddToCart }) {
  return (
    <div><div className="card bg-white w-76 shadow-xl font-poppins">
    ...
    <div className="card-body items-center text-center">
      ...
      <p>{description}</p>
      <h2 className="text-red-600 text-2xl">highest bid price<br></br> ${price}</h2>
